...
int uart_init(void)
{
    ...
    write32(uart_base + ULCON, ULCON_CS8);
    write32(uart_base + UCON, UCON_DEFAULT);
    write32(uart_base + UFCON, 0);
    write32(uart_base + UMCON, UMCOM_RTS_LOW);
    uart_setbaud(115200);
