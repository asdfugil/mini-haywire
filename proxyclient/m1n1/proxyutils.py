...
class ProxyUtils(Reloadable):
    ...
    def __init__(self, p, heap_size=1024 * 1024 * 1024):
        ...
        # We allocate a 32MB heap, 32MB after the m1n1 heap, without telling it about it.
        # This frees up from having to coordinate memory management or free stuff after a Python
        # script runs, at the expense that if m1n1 ever uses more than 32MB of heap it will
        ...
        self.heap_base += 32 * 1024 * 1024 # We leave 32MB for m1n1 heap
    ...
    def get_adt(self):
        ...
        adt_base = (self.ba.devtree - self.ba.virt_base + self.ba.phys_base) & 0xffffffff
